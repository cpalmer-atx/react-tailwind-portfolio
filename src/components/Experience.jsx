const Experience = () => {
  return (
    <div name='experience' className="relative container mx-auto p-6 h-screen max-w-full bg-gradient-to-tr from-primary via-primary to-secondary">
      <div className="flex flex-col p-8 justify-center mx-auto h-full max-w-5xl">
        <h1 className="text-primaryTxt text-4xl">Experience</h1>
