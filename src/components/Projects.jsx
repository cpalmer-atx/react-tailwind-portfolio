const Projects = () => {
  return (
    <div name='projects' className="relative container mx-auto p-6 h-screen w-full max-w-5xl bg-gradient-to-tr from-primary via-primary to-secondary">
      <div className="flex flex-col p-8 justify-center mx-auto h-full">
        <h1 className="text-primaryTxt text-4xl">Projects</h1>
